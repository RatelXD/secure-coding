...
|---|---|---|---|---|
| 2026-07-16 | 최종 자동 테스트 | `pytest -q` | 159 tests, 213 subtests PASS | PASS |
...
| 2026-07-16 | 1차 통합 스위트 | 당시 `pytest -q`가 154 tests, 210 subtests PASS | 당시 수정본의 회귀 근거; 최종 159 tests, 213 subtests는 B.1에 기록 |
